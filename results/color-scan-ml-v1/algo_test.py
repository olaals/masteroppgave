...
def test_dataset(dataset_path, test_path):
    ...
    for idx in range(len(gt_paths)):
        ...
        gt_img = np.where(gt_img>20, gt_img, 0)
        ...
        stacked = stack_ground_truth_pred(gt_img, pred_img, left_scan, left_scan)
        cv2_imwrite(os.path.join(result_scan_dir, "gt_img.png"), gt_img)
